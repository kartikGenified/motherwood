  ...
  return (
    ...
    >
      ...
      <View>
        ...
        <PoppinsTextMedium style={{ color: "black", fontSize: 16, fontWeight: '600', marginHorizontal: 20, marginTop: 10 }} content={"For more updates, please follow us on"}></PoppinsTextMedium>

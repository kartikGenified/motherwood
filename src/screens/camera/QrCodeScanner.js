        ...
        if (data?.unique_code != undefined) {
          try {
            ...
            if (credentials) {
              ...
              if (response?.data) {
                console.log("Verify qr dataasdsa", JSON.stringify(response));
                ...
                if (qrStatus === "1") {
                  ...
                  console.log("QR status is 2",statusCode)
                  ...
                  if (statusCode === 201) {
                    ...
                    {
                      setTimeout(() => {
                        console.log("scannning already scanned qr code unable to scan again again")

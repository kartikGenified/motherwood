...
const PointHistory = ({ navigation }) => {
  ...
  const fetchPointHistoryData = (start, end) => {
    (async () => {
      ...
      console.log("fetching point history data by date filter", {
        startDate: startDate,
        endDate: endDate,
        token: token,
        userId: userId,
  ...
  useEffect(() => {
    if (fetchUserPointsHistoryData) {
      console.log(
        ...
        JSON.stringify(fetchUserPointsHistoryData)
      );
      ...
      >
        ...
        >
          {type !== "registration_bonus" && (
            <PoppinsTextMedium
              style={{ fontWeight: "700", fontSize: 14, color: "black" }}
              content={description}
            ></PoppinsTextMedium>
          )}
          {type === "registration_bonus" && (
        ...
        >
          <View style={{ flexDirection: "row" }}>
            ...
            <PoppinsTextMedium
              style={{
                textDecorationLine: is_reverted ? "line-through" : "",
                color: "#91B406",
                fontSize: 14,
                color: status == 0 && is_reverted == true ? "red" : "black",
              }}
              content={`${
                status == "1" ? " +" : status == "2" ? " -" : ""
              } ${amount}`}
  ...
  return (
    ...
    >
      ...
      >
        <View style={{ margin: 20, flexDirection: "row" }}>
          ...
          <View style={{ marginLeft: 10 }}>
            <PoppinsTextLeftMedium
              style={{ fontSize: 22, color: "black", fontWeight: "800" }}
              content={"1600"}
            ></PoppinsTextLeftMedium>
            <PoppinsTextLeftMedium
        ...
        <TouchableOpacity style={{ backgroundColor:ternaryThemeColor, alignItems:'center', justifyContent:'center', borderRadius:30,height:45,width:160,marginLeft:20}} onPress={()=>{}}>
      ...
      {displayList && !isLoading && (
        <FlatList
          ...
          renderItem={({ item, index }) => {
            ...
            return (
              <ListItem
                visibleCode={item.batch_running_code}

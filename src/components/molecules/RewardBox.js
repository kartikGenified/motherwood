        ...
        <View style={{ padding: 4, width: '100%', borderRadius: 14, elevation: 4, backgroundColor: 'white', height: 170 }}>
             ...
             */}
             <View style={{width:'100%',flexDirection:'row',alignItems:'center', justifyContent:'center'}}>
                ...
                {
                  <RewardSquare amount={(userPointData?.body.point_earned ? userPointData?.body.point_earned : 0)} color="#DCF0FF" image={require('../../../assets/images/balance_black.png')} title={t("Received points")}></RewardSquare>
                }
                    {
                  <RewardSquare amount={(userPointData?.body.transfer_points ? userPointData?.body.transfer_points : 0)} color="#F0FCE7" image={require('../../../assets/images/transferable.png')} title={t("Transferable points")}></RewardSquare>
                }

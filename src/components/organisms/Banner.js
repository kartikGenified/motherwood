...
const Banner = (props) => {
  ...
  return (
    <GestureRecognizer
      ...
      <View style={{ height: 230, width: '90%',alignItems:"center",justifyContent:"center" }}>
        {showImage && <Image style={{ height: 230, width: '100%',resizeMode:'contain' }} source={{ uri: showImage }} />}

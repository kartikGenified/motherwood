  ...
  const handleMenuItemPress = (data) => {
    if (data.substring(0, 4).toLowerCase() === "scan") {
      ...
      Platform.OS == "android"
        ...
        : navigation.navigate("ScanReturn");
    } else if (data.toLowerCase() === "return list") {
      navigation.navigate("ReturnList");
    } else if (data.toLowerCase() === "Points Calculator") {
      // navigation.navigate("ReturnList")
    } else if (
      data.toLowerCase() === "checkout" ||
      data.toLowerCase() === "assign" ||
      data.toLowerCase() == "assign product"
    ) {
      ...
      data.toLowerCase() === "add user" ||
      data.toLowerCase() === "retailer list"
    ) {

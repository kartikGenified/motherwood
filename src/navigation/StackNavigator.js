    ...
    <NavigationContainer>
      <Stack.Navigator>
        ...
        <Stack.Screen
          ...
          name="ExtraPointHistory"
          component={ExtraPointHistory}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        <Stack.Screen
          ...
          name="PointsTransferNext"
          component={PointsTransferNext}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        <Stack.Screen
          ...
          name="KycVerificationNewScreen"
          component={KycVerificationNewScreen}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        <Stack.Screen
          ...
          name="DreamGiftDetails"
          component={DreamGiftDetails}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
        ...
        ></Stack.Screen>
          ...
          name="PointsTransferSuccess"
          component={PointsTransferSuccess}
        ></Stack.Screen>
        <Stack.Screen
          options={{
            headerShown: false,
